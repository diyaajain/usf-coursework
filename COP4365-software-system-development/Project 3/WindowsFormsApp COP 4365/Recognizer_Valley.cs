        ...
        public override bool Recognize(List<SmartCandlestick> scsList, int index)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    bool valley = (scs.low < prev.low) & (scs.low < next.low); // Condition for valley
                    scs.Dictionary_Pattern.Add(Pattern_Name, valley); // Store the calculated result for future use
                    return valley;
                }
            }
        }
